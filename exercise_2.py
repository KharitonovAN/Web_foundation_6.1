        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Заказ</h4>
                        </div>
                        <div class="card-body">
                            <form>
                            <div class="mb-3">
                                <input name="name" type="Name" class="form-control" id="exampleInputName1" placeholder="Name">
                            </div>
                            <div class="mb-3">
        ...
        <main class="row">
            <div class="row text-center">
                <div class="col-16">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-100 fw-normal">FAQ</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <p class="d-inline-flex gap-1">
                                ...
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="multiCollapseExample2">Как доставить?</button>
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#multiCollapseExample3" aria-expanded="false"
                                        aria-controls="multiCollapseExample3">Какая гарантия?</button>
                            </p>
                            <div class="row">
                                <div class="col">
